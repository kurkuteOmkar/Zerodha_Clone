 ...
 export default function Footer(){
    return (
      <footer style={{backgroundColor:"#FBFBFB" ,height:"auto"}}>
  <div className="container a-link border-top mt-5" >
    <div className="row mt-5">
      <div className="col ">
        <img src="media/images/logo.svg" className="mb-3" alt="" style={{width:"75%"}}/>
...
All rights reserved.
      ...
      <div className="col" style={{height:"auto"}}>
        <p>Account</p>
       <a href="" style={{textDecoration:"none",fontSize:"14px"}} className="text-muted">Open demat account</a><br />
